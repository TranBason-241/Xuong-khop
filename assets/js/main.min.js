  ...
  nextAction = () => {
    ...
    if (currentItemActions.length < 1) {
      ...
      if (swiper.activeIndex == 5) {
        ...
        lisItemToShow = currentSlide.querySelectorAll(".action:not(.show)");
        itemActionToShow = lisItemToShow[0];
        if (itemActionToShow !== null && itemActionToShow !== undefined) {
          itemActionToShow.classList.add("show");
          // /?Slide cắt hinhgf
          if (swiper.activeIndex !== 1) {
            let nextElement = itemActionToShow.nextElementSibling;
  ...
  prevAction = () => {
    ...
    if (currentItemActions.length < 1) {
      ...
      if (swiper.activeIndex == 5) {
        ...
        lisItemToShow = currentSlide.querySelectorAll(".action.show");
        itemActionToShow = lisItemToShow[lisItemToShow.length - 1];
        if (itemActionToShow !== null && itemActionToShow !== undefined) {
          console.log(itemActionToShow);
          itemActionToShow.classList.remove("show");
          if (swiper.activeIndex !== 1) {
            let nextElement = itemActionToShow.nextElementSibling;
